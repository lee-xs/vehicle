...
public class VehicleUtils {
    ...
    //生成地区车牌号
    public static String create(String region){
        Random random = new Random();
        //随机产生一个车牌号头部分的字符串
        String head = ("".equals(region)? CARNUMBERHEADLIST[random.nextInt(CARNUMBERHEADLIST.length)]:region)  + "·";
        //定义一个6位数的车牌数组
